document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeFilter() {
        ...
        filterBtn.addEventListener('click', () => {
                ...
                <div class="bg-white rounded-lg shadow-xl p-6 w-[400px] max-w-[90vw]">
                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <select class="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
            ...
            applyBtn.addEventListener('click', () => {
                const priority = modal.querySelector('select:nth-child(1)').value;
                const team = modal.querySelector('select:nth-child(2)').value;
                const jobType = modal.querySelector('select:nth-child(3)').value;
